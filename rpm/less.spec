...
%changelog
* Sun Feb 28 2010 Anas Nashif <anas.nashif@intel.com> - 436
- add ncurses to BuildRequires
* Mon Feb  1 2010 Zhang, Qiang Z<qiang.z.zhang@intel.com> 436
- Update to 436 & switch to spectacle building
* Mon Nov 24 2008 Anas Nashif <anas.nashif@intel.com> 418
...
- Fixed -F option
- Resolves: #427551
* Fri Jan  4 2008 Zdenek Prikryl <zprikryl@redhat.com> - 418-1
- Update to 418
...
* Tue Feb  7 2006 Jesse Keating <jkeating@redhat.com> - 394-2.1
...
* Tue Mar  2 2004 Karsten Hopp <karsten@redhat.de> 382-1.1 
- build for FC1
...
* Mon Nov  4 2002 Karsten Hopp <karsten@redhat.de>
- less-378
- added some debian patches
- show image info instead of binary garbage when viewing images
* Fri Oct  5 2001 Karsten Hopp <karsten@redhat.de>
- fix line numbering (less -N filename), caused by
  a broken i18n patch
* Tue Sep  4 2001 Karsten Hopp <karsten@redhat.de>
...
* Thu Feb  1 2001 Karsten Hopp <karsten@redhat.de>
...
* Thu May  7 1998 Prospector System <bugs@redhat.com>
